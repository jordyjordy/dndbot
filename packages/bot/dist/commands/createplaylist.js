...
const execute = function (msg) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (!(yield connectionManager.createPlaylist(args[0]))) {
                (0, messageReply_1.reply)(msg, "something went wrong, possibly you entered a bad url.");
            }
            yield (0, messageReply_1.reply)(msg, "You added " + args[0]);
