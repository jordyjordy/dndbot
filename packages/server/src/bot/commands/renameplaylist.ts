...
const data = new SlashCommandBuilder()
    ...
    .addIntegerOption(option => option.setName('id').setDescription('Id of the playlist').setRequired(true))
    .addStringOption(option => option.setName('name').setDescription('Enter a new name').setRequired(true))
